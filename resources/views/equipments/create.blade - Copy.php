...
<div id="calibrationTab" class="form-tab-content" style="display: none;">
  <!-- إضافة / تعديل المعايرة -->
  <fieldset class="form-section-fieldset">
    <legend>Add / Edit Calibration</legend>
    ...
    <div class="form-row checkboxes-row">
      ...
      <div class="form-group custom-checkbox">
        <input type="checkbox" id="has_next_calibration" name="has_next_calibration" value="{{ date('Y-m-d') }}>
  ...
  <div class="form-group">
    ...
    <input type="date" name="scheduled" id="scheduled"  value="{{ date('Y-m-d') }}">
  </div>
  <div class="form-group custom-checkbox">
...
<div id="edit-calibrationTab" class="form-tab-content" style="display:none;">
  <fieldset class="form-section-fieldset">
    ...
    <!-- Hidden fields -->
    <input type="hidden" id="edit_calibration_id" name="edit_calibration_id">
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Calib. Method:</label>
        <input type="text" id="edit_calib_method" name="edit_calib_method">
      </div>
      <div class="form-group">
        <label>Calib. Procedure No:</label>
        <input type="text" id="edit_calib_procedure_no" name="edit_calib_procedure_no">
      </div>
      <div class="form-group">
        <label>Last Calib. Date:</label>
        <input type="date" id="edit_last_calib_date" name="edit_last_calib_date">
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Scheduled:</label>
        <input type="date" id="edit_scheduled_calib" name="edit_scheduled_calib">
      </div>
      <div class="form-group">
        <label>Next Calib. Date:</label>
        <input type="date" id="edit_next_calib_date" name="edit_next_calib_date">
      </div>
      <div class="form-group custom-checkbox">
        <input type="checkbox" id="edit_reminder_calib" name="edit_reminder_calib">
        <label for="edit_reminder_calib">Reminder</label>
      </div>
    </div>
    ...
    <div class="form-row checkboxes-row">
      <div class="form-group custom-checkbox">
        <input type="checkbox" id="edit_has_next_calibration" name="edit_has_next_calibration">
        <label for="edit_has_next_calibration">Has Next Calibration</label>
      </div>
      <div class="form-group custom-checkbox">
        <input type="checkbox" id="edit_only_one_calib" name="edit_only_one_calib">
        <label for="edit_only_one_calib">Only One</label>
      </div>
      <div class="form-group custom-checkbox">
        <input type="checkbox" id="edit_calibrated_externally" name="edit_calibrated_externally">
        <label for="edit_calibrated_externally">Calibrated Externally</label>
      </div>
    </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        <label>Internally By:</label>
        <input type="text" id="edit_internally_by" name="edit_internally_by">
      </div>
      <div class="form-group">
        <label>Last Certificate:</label>
        <input type="text" id="edit_last_certificate" name="edit_last_certificate">
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Calibration Status:</label>
        <select id="edit_calibration_status" name="edit_calibration_status">
          <option value="completed">Completed</option>
          <option value="scheduled">Scheduled</option>
          <option value="overdue">Overdue</option>
        </select>
    ...
    <!-- Toolbar -->
    <div class="contact-toolbar" style="margin-top:15px;">
      <button type="button" class="btn btn-primary" onclick="saveCalibration('edit')">💾 Save / Update</button>
      <button type="button" class="btn btn-secondary" onclick="clearEditCalibrationForm()">🧹 Clear Form</button>
    </div>
  </fieldset>
</div>
...
<div id="editEquipmentModal" class="modal">
 ...
 <div class="tab-buttons">
    ...
    <form id="editEquipmentForm">
      ...
      <!-- Equipment Details Tab -->
      <div id="edit-equipment-details" class="form-tab-content">
        <fieldset class="form-section-fieldset">
          <legend>Equipment Information</legend>
          <div class="form-row">
            <div class="form-group"><label>Equipment Ref:</label><input type="text" id="edit_equipment_reference" name="equipment_reference" readonly></div>
            <div class="form-group"><label>Alternative Id:</label><input type="text" id="edit_alternative_id" name="alternative_id"></div>
            <div class="form-group"><label>Legacy Id:</label><input type="text" id="edit_legacy_id" name="legacy_id"></div>
            <div class="form-group"><label>Description:</label><input type="text" id="edit_description" name="description" required></div>
          </div>
          <div class="form-row">
            <div class="form-group"><label>Serial #:</label><input type="text" id="edit_serial_number" name="serial_number"></div>
            <div class="form-group"><label>Asset Tag:</label><input type="text" id="edit_asset_tag" name="asset_tag"></div>
      ...
      <div id="edit-calibrationTab" class="form-tab-content" style="display:none;">
        <fieldset class="form-section-fieldset">
          ...
          <div class="form-row">
            ...
            <div class="form-group custom-checkbox"><input type="checkbox" id="edit_reminder" name="reminder"><label for="edit_reminder">Reminder</label></div>
          </div>
          <!-- Add other calibration fields as needed -->
        </fieldset>
      </div>
      ...
      <div id="edit-maintenanceTab" class="form-tab-content" style="display:none;">
        <fieldset class="form-section-fieldset">
          ...
          <input type="hidden" id="edit_maintenance_id" name="edit_maintenance_id">
          <div class="form-row">
            <div class="form-group"><label>Last Maint. Date:</label><input type="date" id="edit_last_maint_date" name="edit_last_maint_date"></div>
            <div class="form-group"><label>Scheduled Date:</label><input type="date" id="edit_scheduled_date" name="edit_scheduled_date"></div>
            <div class="form-group"><label>Next Maint. Date:</label><input type="date" id="edit_next_maint_date" name="edit_next_maint_date"></div>
          </div>
          <!-- Add other maintenance fields as needed -->
        </fieldset>
      </div>
